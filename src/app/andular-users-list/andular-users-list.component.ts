...
@Component({
  selector: 'app-andular-users-list',
  templateUrl: './andular-users-list.component.html',
  styleUrls: ['./andular-users-list.component.css']
})
export class AndularUsersListComponent implements OnInit {
  users: Array<any> = [];
  newLogin: string;
  newPassword: string;
  newEmail: string;
